...
class TestFormatter(TestBase):
    ...
    def test_formatter_rex(self):
        ...
        self.assert_formatter_equal(
            "Hello, ${{world}}!", "Hello, ${world}!", world="Earth"
        )
    ...
    def test_formatter_stdlib(self):
        ...
        self.assert_formatter_equal(
            "My name is {0[name]}", "My name is Fred", dict(name="Fred")
        )
        self.assert_formatter_equal(
            "My name is {0} :-{{}}", "My name is Fred :-{}", "Fred"
        )
        ...
        self.assert_formatter_equal(
            "{0:date: %Y-%m-%d}", "date: 2007-08-27", I(year=2007, month=8, day=27)
        )
        ...
        self.assert_formatter_equal(
            "{0:.{precision}s}", "hello", "hello world", precision=5
        )
        self.assert_formatter_equal(
            "{0:{width}.{precision}s}",
            "hello     ",
        ...
        self.assert_formatter_raises(
            "{0:{1:{2:{3:{4:{5:{6}}}}}}}", ValueError, 0, 1, 2, 3, 4, 5, 6, 7
        )
    ...
    def test_formatter_recurse(self):
        self.assert_formatter_equal(
            "Hello {0}!", "Hello Earth!", "{world}", world="Earth"
        )
        ...
        self.formatter.namespace.update(
            greeted="{dinosaur}",
            person="{Bob}",
            Bob="Fabulous Bobby",
            dinosaur="{Trex}",
